...
export const siteName = 'Ezra Mechaber';
export const siteDescription = 'Product person. Brooklyn, NY.';
...
export const author = {
  ...
  website: 'https://ezramechaber.com' // i.e. https.://www.lenesaile.com - the personal site of the author
};
export const creator = {
  name: 'Ezra Mechaber', // i.e. Lene Saile - creator's (developer) name.
  email: 'contact@ezramechaber.com',
  website: 'https://ezramechaber.com',
};
...
export const blog = {
  // RSS feed
  name: 'Ezra Mechaber',
  description: 'Product person. Brooklyn, NY',
